...
This is the `release-26.05` branch of System Manager, which tracks Nixpkgs `nixos-26.05`.
...
You are looking at the `release-26.05` branch, which supports Nixpkgs `nixos-26.05` only.
For `nixos-unstable`, use the `main` branch instead.
