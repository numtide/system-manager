// This code was autogenerated with `dbus-codegen-rust -c blocking -d org.freedesktop.systemd1 -f org.freedesktop.systemd1.Manager -p /org/freedesktop/systemd1 -m None`, see https://github.com/diwic/dbus-rs
    ...
    OrgFreedesktopSystemd1Manager for blocking::Proxy<'a, C>
{
    ...
    fn get_unit_processes(&self, name: &str) -> Result<Vec<(String, u32, String)>, dbus::Error> {
        ...
        .map(|r: (Vec<(String, u32, String)>,)| r.0)
    }
