...
//   * with "wasi:cli/exit@0.2.9" = "crate::cli::exit"
...
//   * with "wasi:cli/terminal-input@0.2.9" = "crate::cli::terminal_input"
//   * with "wasi:cli/terminal-output@0.2.9" = "crate::cli::terminal_output"
//   * with "wasi:cli/terminal-stdin@0.2.9" = "crate::cli::terminal_stdin"
//   * with "wasi:cli/terminal-stdout@0.2.9" = "crate::cli::terminal_stdout"
//   * with "wasi:cli/terminal-stderr@0.2.9" = "crate::cli::terminal_stderr"
...
//   * with "wasi:filesystem/types@0.2.9" = "crate::filesystem::types"
//   * with "wasi:filesystem/preopens@0.2.9" = "crate::filesystem::preopens"
...
//   * with "wasi:random/insecure@0.2.9" = "crate::random::insecure"
//   * with "wasi:random/insecure-seed@0.2.9" = "crate::random::insecure_seed"
//   * with "wasi:sockets/network@0.2.9" = "crate::sockets::network"
//   * with "wasi:sockets/instance-network@0.2.9" = "crate::sockets::instance_network"
//   * with "wasi:sockets/tcp@0.2.9" = "crate::sockets::tcp"
//   * with "wasi:sockets/tcp-create-socket@0.2.9" = "crate::sockets::tcp_create_socket"
//   * with "wasi:sockets/udp@0.2.9" = "crate::sockets::udp"
//   * with "wasi:sockets/udp-create-socket@0.2.9" = "crate::sockets::udp_create_socket"
//   * with "wasi:sockets/ip-name-lookup@0.2.9" = "crate::sockets::ip_name_lookup"
//   * type_section_suffix: "rust-wasip2-1.0.3+wasi-0.2.9-from-crates-io-command-world"
            ...
            pub mod run {
                ...
                macro_rules! __export_wasi_cli_run_0_2_9_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        ...
                        "wasi:cli/run@0.2.9#run")] unsafe extern "C" fn export_run() ->
                        i32 { unsafe { $($path_to_types)*:: _export_run_cabi::<$ty > () }
                        } };
                    };
                }
                #[doc(hidden)]
                pub use __export_wasi_cli_run_0_2_9_cabi;
            }
        }
    }
}
...
macro_rules! __export_command_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        ...
        "component-type:wit-bindgen:0.57.1:wasi:cli@0.2.9:command:imports and exportsrust-wasip2-1.0.3+wasi-0.2.9-from-crates-io-command-world")]
...
#[cfg_attr(feature = "rustc-dep-of-std", unsafe(link_section = "component-type:wit-bindgen:0.57.1:wasi:cli@0.2.9:command-with-all-of-its-exports-removed:encoded worldrust-wasip2-1.0.3+wasi-0.2.9-from-crates-io-command-world-in-libstd"))]
#[cfg_attr(not(feature = "rustc-dep-of-std"), unsafe(link_section = "component-type:wit-bindgen:0.57.1:wasi:cli@0.2.9:command-with-all-of-its-exports-removed:encoded worldrust-wasip2-1.0.3+wasi-0.2.9-from-crates-io-command-world"))]
