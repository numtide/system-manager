...
// Options used:
//   * std_feature
//   * type_section_suffix: "rust-wasip2-1.0.3+wasi-0.2.9-from-crates-io"
#[rustfmt::skip]
...
#[cfg_attr(feature = "rustc-dep-of-std", unsafe(link_section = "component-type:wit-bindgen:0.57.1:wasi:cli@0.2.9:imports:encoded worldrust-wasip2-1.0.3+wasi-0.2.9-from-crates-io-in-libstd"))]
#[cfg_attr(not(feature = "rustc-dep-of-std"), unsafe(link_section = "component-type:wit-bindgen:0.57.1:wasi:cli@0.2.9:imports:encoded worldrust-wasip2-1.0.3+wasi-0.2.9-from-crates-io"))]
