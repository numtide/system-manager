...
# The upstream openssh module cannot work as is as long as we do not fix
# the PAM setup. See https://github.com/numtide/system-manager/issues/415
#
# For now, we're vendoring the sshd config file generation and re-use the
# host systemd sshd service and openssh binary.
#
# Most of this volume is part of the upstream module vendored here.
let
