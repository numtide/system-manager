...
System Manager supports systemd-based distributions including Ubuntu, Debian, Fedora, Rocky Linux, AlmaLinux, and Arch Linux.
See [supported platforms](../reference/supported-platforms.md) for the full list.

# Initializing Your System

Before proceeding, ensure you have [installed Nix with flakes enabled](../how-to/install.md).
